...
namespace OpenUpMan.Services
{
    ...
    {
        Task<DocumentServiceResult> CreateDocumentAsync(Guid phaseItemId, string title, Guid createdBy, string? description = null, CancellationToken ct = default);
        ...
        Task<IEnumerable<Document>> GetDocumentsByCreatorAsync(Guid creatorId, CancellationToken ct = default);
