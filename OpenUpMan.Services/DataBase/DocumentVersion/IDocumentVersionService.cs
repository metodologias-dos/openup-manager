...
namespace OpenUpMan.Services
{
    ...
    {
        Task<DocumentVersionServiceResult> CreateVersionAsync(Guid documentId, Guid createdBy, string filePath, string? observations = null, CancellationToken ct = default);
